...
def save_audio():
    ...
    nome="LamIra"
    path=r'/Users/marco/Google Drive/Tesi/Media/Audio/'
    ...
    dict_message={"Welcome":welcome_message_list,"Quit":quit_message_list,"Error":error_message_list,"Undefined":undefined_message_list, "Query":query_message_list, "Cannot_answer":cannot_answer_message_list}
